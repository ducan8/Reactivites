...
namespace Application.Photos
{
    public class Add
    {
        ...
        public class Handler : IRequestHandler<Command, Result<Photo>>
        {
            ...
            public Handler(DataContext context, IPhoroAccessor phoroAccessor, IUserAccessor userAccessor)
            {
                _context = context;
            ...
            public async Task<Result<Photo>> Handle(Command request, CancellationToken cancellationToken)
            {
                ...
                var photoUploadResult = await _phoroAccessor.AddPhoto(request.File);
